...
Foram medidos $14$ fusores nos mesmos $870$ folds, com DSEL disjunto e $k=7$
vizinhos.
...
O GA tem o \emph{maior} \On{1} de todos ($0.9976$) e a \emph{menor} votação
majoritária de todas ($0.7784$). A folga resultante, $0.2192$, é $54\%$ maior que a
do Random Forest (Friedman $p=0.0045$; GA \emph{vs} RF acima da diferença crítica,
...
Lithuanian e Banana a recuperação média do GA é $0.766$, contra $0.157$ do Bagging e
...
que o GA usa na função de \emph{fitness}, o que favorecia o GA por construção. O
protocolo atual separa as duas partições. Isolar o viés exige separar dois efeitos
simultâneos --- o viés removido (só afeta o GA) e o DSEL pela metade (afeta os três
...
controle perdeu $-0.0057$ de folga recuperada, o GA perdeu $-0.0003$, logo o viés é
$+0.0055$ --- cerca de $3\%$ relativos, e nenhum dos deltas é significativo. O
desenho anterior \textbf{não} estava inflando materialmente a vantagem do GA; a
